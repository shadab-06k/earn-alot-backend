...
exports.getPointsSummary = exports.calculateBonusPoints = exports.extractReferralCode = exports.isValidReferralCode = exports.getNextTierInfo = exports.getPointsBreakdown = exports.getAllReferralTiers = exports.getReferralTier = exports.calculateTotalPointsEarned = exports.calculatePointsForReferral = void 0;
/**
 ...
 */
const calculatePointsForReferral = (referralCount) => {
...
exports.calculateTotalPointsEarned = calculateTotalPointsEarned;
/**
...
const getReferralTier = (referralCount) => {
    ...
    const totalPointsAtTier = (0, exports.calculateTotalPointsEarned)(referralCount);
    return {
        tier,
        referralsRequired,
        multiplier,
...
exports.getReferralTier = getReferralTier;
/**
 * Get all referral tiers (1-10)
 * @returns Array of all referral tiers with their details
 */
const getAllReferralTiers = () => {
    const tiers = [];
    for (let tier = 1; tier <= 10; tier++) {
        const referralsRequired = tier * 10;
        const multiplier = Math.min(1.0 + ((tier - 1) * 0.2), 3.0);
        const pointsPerReferral = 100 * multiplier;
        const totalPointsAtTier = (0, exports.calculateTotalPointsEarned)(referralsRequired);
        tiers.push({
            tier,
            referralsRequired,
            multiplier,
 ...
 */
const getNextTierInfo = (currentReferrals) => {
    const currentTier = (0, exports.getReferralTier)(currentReferrals);
 ...
 */
const extractReferralCode = (uniqueID) => {
...
const calculateBonusPoints = (referralCount) => {
    ...
    if (referralCount >= 10)
        bonusPoints += 50; // First 10 referrals bonus
    if (referralCount >= 25)
        bonusPoints += 100; // 25 referrals bonus
    if (referralCount >= 50)
        bonusPoints += 200; // 50 referrals bonus
    if (referralCount >= 100)
        bonusPoints += 500; // 100 referrals bonus
    return bonusPoints;
};
 ...
 */
const getPointsSummary = (referralCount) => {
    const tier = (0, exports.getReferralTier)(referralCount);
    const totalPoints = (0, exports.calculateTotalPointsEarned)(referralCount);
    const bonusPoints = (0, exports.calculateBonusPoints)(referralCount);
    const nextTier = (0, exports.getNextTierInfo)(referralCount);
    return {
        ...
        nextTier: nextTier,
        breakdown: (0, exports.getPointsBreakdown)(referralCount)
    };
};
exports.getPointsSummary = getPointsSummary;
